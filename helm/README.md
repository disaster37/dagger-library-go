...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src . ci export --path .
```
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src /path/to/chart with-workdir --path subchart lint
```
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src . with-repository \
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src /path/to/chart lint
```
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src . generate-schema export --path .
```
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src /path/to/chart generate-documentation export --path .
```
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src . migrate-values-tags export --path ./values.yaml
```
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src . update-chart --key .version --value 1.2.3 export --path .
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src . update-values --key .image.tag --value latest export --path .
```
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src /path/to/chart push --registry-url ghcr.io --repository-name myorg/mychart --version 1.2.3 export --path .
```
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src . ci \
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src . generate-ci --ci github --helm-paths charts/myapp export --path .
```
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 \
...
**Override module ref:**
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src . generate-ci --ci github --module-ref github.com/myorg/helm@v3 export --path .
```
...
```bash
dagger call -m github.com/disaster37/dagger-library-go/helm@2.0.6 --src . ci --ci github --dry-run export --path .
```
