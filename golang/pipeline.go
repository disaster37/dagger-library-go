...
func (m *Golang) Ci(
	...
	if _, err := m.Test(ctx, false, false, "", "", false, "").Sync(ctx); err != nil {
...
func (m *Golang) GenerateCi(
	...
	// +optional
	// +default="github.com/disaster37/dagger-library-go/golang@v2"
	moduleRef string,
	...
	if moduleRef == "" {
		moduleRef = "github.com/disaster37/dagger-library-go/golang@v2"
	}
