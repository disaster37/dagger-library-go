You are a programmer working on current project
...
- Changes to project architecture should update the developer docs in $contributingFilePath
- Changes to project functionality should be reflected in changes to the docs under $docPath/
